  ...
  <body>
    <div class="container">
      <form action="#">
        ...
        <div class="field">
          <input onkeyup="active()" id="email" type="email" placeholder="Enter Email">
        </div>
        <div class="field">
    ...
    <script>
      ...
      btn.onclick = function(){
        if(email.value != pswrd_1.value != pswrd_2.value){
      ...
      function active_2(){
        if(pswrd_2.value != ""){
          ...
          showBtn.onclick = function(){
            if((email.type == "email") && (pswrd_1.type == "password") && (pswrd_2.type == "password")){
              email.type = "text";
              pswrd_1.type = "text";
              pswrd_2.type = "text";
